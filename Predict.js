...
var testingSampleIndex = 1, lastIndex = 0;
...
function Test(){
  if (testingSampleIndex != lastIndex) {
    lastIndex = testingSampleIndex;
...
function GotResults(err,result){
  predictedClassLabels.set(testingSampleIndex,result.classIndex);
